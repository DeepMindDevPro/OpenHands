...
export enum I18nKey {
  ...
  CONVERSATION$CONTEXT_CONDENSED = "CONVERSATION$CONTEXT_CONDENSED",
  CONVERSATION$HISTORICAL_EVENT_SUMMARIZED = "CONVERSATION$HISTORICAL_EVENT_SUMMARIZED",
  CONVERSATION$HISTORICAL_EVENTS_SUMMARIZED = "CONVERSATION$HISTORICAL_EVENTS_SUMMARIZED",
  CONVERSATION$CONDENSATION_AT_TURN = "CONVERSATION$CONDENSATION_AT_TURN",
  CONVERSATION$CLOSE = "CONVERSATION$CLOSE",
  CONVERSATION$BEFORE = "CONVERSATION$BEFORE",
  CONVERSATION$AFTER = "CONVERSATION$AFTER",
  CONVERSATION$DROP = "CONVERSATION$DROP",
  CONVERSATION$PROMPT_TOKENS_LABEL = "CONVERSATION$PROMPT_TOKENS_LABEL",
  CONVERSATION$FORGOTTEN_EVENTS = "CONVERSATION$FORGOTTEN_EVENTS",
  CONVERSATION$CONDENSER_COST = "CONVERSATION$CONDENSER_COST",
  CONVERSATION$SUMMARY_LABEL = "CONVERSATION$SUMMARY_LABEL",
  CONVERSATION$TURNS_UNTIL_CONDENSATION = "CONVERSATION$TURNS_UNTIL_CONDENSATION",
  CONVERSATION$OVERVIEW = "CONVERSATION$OVERVIEW",
  CONVERSATION$TOKEN_TIMELINE = "CONVERSATION$TOKEN_TIMELINE",
  CONVERSATION$USAGE_RATE = "CONVERSATION$USAGE_RATE",
  CONVERSATION$CONDENSATION_LABEL = "CONVERSATION$CONDENSATION_LABEL",
  CONVERSATION$TURN_LABEL = "CONVERSATION$TURN_LABEL",
  CONVERSATION$NO_TOKEN_DATA = "CONVERSATION$NO_TOKEN_DATA",
